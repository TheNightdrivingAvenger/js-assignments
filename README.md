...
## Javascript Assignments  [![Build Status](https://travis-ci.org/TheNightdrivingAvenger/js-assignments.svg?branch=master)](https://travis-ci.org/TheNightdrivingAvenger/js-assignments)
