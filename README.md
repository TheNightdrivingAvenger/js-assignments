...
## Javascript Assignments  [![Build Status](https://travis-ci.org/TheNightdrivingAvenger/js-assignments.svg?branch=lab-3)](https://travis-ci.org/TheNightdrivingAvenger/js-assignments)
...
```
* Open https://github.com/TheNightdrivingAvenger/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/TheNightdrivingAvenger/js-assignments/builds).
...
My lab 3 solution is [here](https://www.github.com/TheNightdrivingAvenger/js-assignments)
